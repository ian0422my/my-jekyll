...
* launch by running command below
* run gitlab
  * docker run -d -p 8081:8081 --name nexus1 --network keycloak_default --restart always sonatype/nexus3:latest
* launch <http://nexus1:9081/>
* get root password
  * docker exec -it nexus1 cat /opt/sonatype/sonatype-work/nexus3/admin.password
    * 6004d713-54fe-49af-95e9-c00c6fc1db41
